	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bgg.jpg');">
			<div class="wrap-login100">
				<form action="entrar.php" method="post" class="login100-form validate-form">
					<div class="naruto">
					...
					<div class="wrap-input100 validate-input" data-validate = "Insira Seu Username">
						<input class="input100" type="text" name="Usuario" placeholder="Insira Seu Username">
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="../registro/cadastro.php">
