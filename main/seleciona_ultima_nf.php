...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bgg.jpg');">
			...
			<form action="insere_item.php?nf='<?php echo $ultimo;?>'" method="post" class="needs-validation" novalidate>
			  ...
			  <div class="form-row" style="display: flex; justify-content: center;">
			    ...
			    <div class="col-md-3 mb-3" style="width: 100%;">
			      ...
			      <select name="produto_opcao" type="text" class="form-control form-control-lg" id="validationCustom05" required>
            	...
            	<?php 
			     ...
			     <div class="col-md-3 mb-3" style="width: 100%;">
			      ...
			      <input name="qtde" type="text" class="form-control" id="validationCustom04" placeholder="Quantidade" required>
			      <div class="invalid-feedback">
